...
| `synthetic-mesh-objects.json` | Saved sample-specific colouring, filtering, combining and refinement choices, followed by current-mesh measurements. Nightly keeps this as the single mesh-object example. |
