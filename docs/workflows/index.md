...
| [Reproduce the statistics-paper compartments](statistics-paper-compartments.md) | You need the CellProfiler 4.2.6 nuclei/cell/cytoplasm profile and the authors' per-cell ratio. |
