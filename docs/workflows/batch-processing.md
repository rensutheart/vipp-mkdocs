...
!!! note "New in 0.15.0a3"
    This feature requires VIPP 0.15.0a3 or newer; it is not included in
    0.15.0a2. Runs made by older versions lack the required
...
shows earlier action labels; 0.15.0a3 controls are described below.*
...
**New in 0.15.0a3:** the compact toolbar has **Resume saved run…**,
...
**New in 0.15.0a3:** the run report card offers **Export reproducibility
...
For [verified resume](#resume-an-interrupted-run), a runner generated by
VIPP 0.15.0a3 also accepts:
