...
!!! warning "Alpha release: validate before interpreting"
    This manual covers **napari-vipp 0.16.0a2**. Download
    only from the canonical
    [GitHub release](https://github.com/rensutheart/napari-vipp/releases/tag/v0.16.0a2)
    or [PyPI page](https://pypi.org/project/napari-vipp/0.16.0a2/).
...
!!! note "New in 0.16.0a2"
    [Registration, per-label skeletons and CPU median acceleration](releases/0.16.0a2.md)
    add whole-volume time-lapse alignment, reusable transforms and skeleton
    measurements joined to the original object IDs. Inspector drop-downs are
    safer to scroll past, and logarithmic plot labels render clearly.

!!! important "Upgrading to 0.16"
    0.16.0a2 writes workflow schema 6. Valid schema-3, schema-4, and schema-5
    ...
    version. Read the [0.16.0a2 release notes](releases/0.16.0a2.md) before upgrading and
    revalidate calculated results afterward.

    Batch configs and manifests are version 6. Verified resume requires a
    compatible original manifest with its recovery evidence; earlier supported records may
...
<a class="vipp-card" href="reference/"><strong>I know what I need</strong><span>Search all nodes, bundled samples, example workflows, settings, formats, and compatibility notes.</span></a>
</div>
...
| Review everything changed in this alpha | [0.16.0a2 release notes](releases/0.16.0a2.md) |
