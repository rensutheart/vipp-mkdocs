...
In 0.13.0a4, manual/cached nodes and nodes selected for isolated tuning use the
...
These nodes are public in 0.13.0a4. They have synthetic examples and automated
