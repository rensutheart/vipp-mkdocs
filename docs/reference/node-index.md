...
In 0.13.0a9, manual/cached nodes and nodes selected for isolated tuning use the
...
These nodes are public in 0.13.0a9. They have synthetic examples and automated
