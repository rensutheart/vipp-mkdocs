...
VIPP 0.13.0a4 accepts schema versions 3 and 4 and rejects versions 1 and 2 with
...
A 0.13.0a4 workflow can carry an optional top-level `batch_config`. The
...
upgrade, including 0.12.0a3 to 0.13.0a4. Interactive caches, thumbnails, pinned
