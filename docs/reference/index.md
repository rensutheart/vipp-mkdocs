...
| Page | Use |
| --- | --- |
| [0.14.0a1 release notes](../releases/0.14.0a1.md) | Review SourceItem identity, microscope readers, OME-Zarr presentation preview, per-sample batch values, installer activity, and limitations. |
