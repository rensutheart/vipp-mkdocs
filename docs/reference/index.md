...
| Page | Use |
| --- | --- |
| [0.13.0a9 release notes](../releases/0.13.0a9.md) | Review mixed CPU/GPU planning, declared 3D processing, sibling measurement caches, GPU VRAM diagnostics, release status, and limitations. |
