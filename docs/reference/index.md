...
| Page | Use |
| --- | --- |
| [0.14.0a2 release notes](../releases/0.14.0a2.md) | Review native macOS installation, detached-window sizing, the PyPI/GitHub package distinction, carried scientific contracts, and current limitations. |
...
| [Workflow and export contract](workflow-contract.md) | Understand schema 5 SourceItems and compute intent, shared-executor Python/CLI, and version-4 batch artifacts. |
