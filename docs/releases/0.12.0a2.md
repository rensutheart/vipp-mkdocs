...
![Isolated Gaussian Blur with a persistent apply/cancel panel and darker-amber waiting descendants](../assets/screenshots/workflows/isolated-node-tuning-0.12.0a2.png)
...
![Bright actionable deconvolution nodes, dark waiting descendants, and an amber Calculate all control](../assets/screenshots/workflows/manual-execution-frontier-0.12.0a2.png)
