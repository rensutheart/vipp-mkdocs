...
0.12.0a3 retains workflow schema 3. Valid schema-3 workflows from 0.12.0a1 and
0.12.0a2 load structurally, but workflow files do not contain cached results.
Recalculate and validate the graph after upgrading, and regenerate any Python
export because generated programs require the exact VIPP runtime version that
created them.
