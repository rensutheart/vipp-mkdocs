...
9. Run **Deploy versioned documentation** again for `0.13.0a5` with
...
```text
mike deploy --push 0.13.0a5
mike deploy --push --update-aliases 0.13.0a5 stable
