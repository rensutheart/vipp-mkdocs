...
VIPP 0.14.0a3 provides separate offline packages for Apple Silicon and Intel
...
the [official v0.14.0a3 release](https://github.com/rensutheart/napari-vipp/releases/tag/v0.14.0a3):

- **Apple Silicon** — the Mac reports a chip such as Apple M1, M2, M3, or M4:
  download `VIPP-0.14.0a3-macOS-arm64-UNSIGNED.pkg` and
  `SHA256SUMS-macOS-arm64-0.14.0a3.txt`.
- **Intel** — the Mac reports an Intel processor: download
  `VIPP-0.14.0a3-macOS-x86_64-UNSIGNED.pkg` and
  `SHA256SUMS-macOS-x86_64-0.14.0a3.txt`.
...
=== "Intel"
    ...
    ```bash
    shasum -a 256 VIPP-0.14.0a3-macOS-x86_64-UNSIGNED.pkg
    ```
...
There is no graphical updater or uninstaller in 0.14.0a3. Unless a later
