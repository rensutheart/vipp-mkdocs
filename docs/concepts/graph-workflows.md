...
| Workflow JSON | Save the graph, node parameters, connections, canvas positions, tunnels, portable schema-6 compute and Run/Bypass intent, stable SourceItems, an optional versioned Batch workspace, and selected UI state. |
